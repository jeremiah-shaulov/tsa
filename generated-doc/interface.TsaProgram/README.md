...
> // curl 'https://raw.githubusercontent.com/jeremiah-shaulov/tsa/v0.0.52/generated-doc/interface.TsaProgram/README.md' | perl -ne 's/^> //; $y=$1 if /^```(.)?/; print $_ if $y&&$m; $m=$y&&$m+/<example-g8c4>/' > /tmp/example-g8c4.ts
