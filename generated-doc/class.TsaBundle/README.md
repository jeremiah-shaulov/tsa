...
```ts
import {TsaBundle} from "https://deno.land/x/tsa@v0.0.32/mod.ts"
```
...
> // curl 'https://raw.githubusercontent.com/jeremiah-shaulov/tsa/v0.0.32/generated-doc/class.TsaBundle/README.md' | perl -ne '$y=$1 if /^```(.)?/;  print $_ if $y&&$m;  $m=$y&&($m||m~<example-n53o>~)' > /tmp/example-n53o.ts
