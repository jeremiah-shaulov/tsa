...
```ts
import {TsaBundle} from "https://deno.land/x/tsa@v0.0.27/mod.ts"
```
...
> // curl 'https://raw.githubusercontent.com/jeremiah-shaulov/tsa/v0.0.27/generated-doc/class.TsaBundle/README.md' | perl -ne '$y=$1 if /^```(.)?/;  print $_ if $y&&$m;  $m=$y&&($m||m~<example-n53o>~)' > /tmp/example-n53o.ts
> // deno run --allow-env --allow-net --allow-read --allow-write /tmp/example-n53o.ts
> 
> import {tsa, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.27/mod.ts';
> 
