# `interface` TemplateExpression `extends` [PrimaryExpression](../interface.PrimaryExpression/README.md)
...
#### 📄 `readonly` kind: [SyntaxKind.TemplateExpression](../enum.SyntaxKind/README.md#templateexpression--229)
