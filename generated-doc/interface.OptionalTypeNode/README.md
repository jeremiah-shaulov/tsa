# `interface` OptionalTypeNode `extends` [TypeNode](../interface.TypeNode/README.md)
...
#### 📄 `readonly` kind: [SyntaxKind.OptionalType](../enum.SyntaxKind/README.md#optionaltype--191)
