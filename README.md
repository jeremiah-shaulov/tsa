...
```bash
deno install --allow-env --allow-net --allow-read --allow-write https://deno.land/x/tsa@v0.0.17/tsa.ts
```
...
import {tsa, printDiagnostics, LoadOptions, EmitDocOptions} from 'https://deno.land/x/tsa@v0.0.17/mod.ts';
...
import {tsa, defaultLoad, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.17/mod.ts';
...
```ts
import {tsa, defaultResolve, defaultLoad, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.17/mod.ts';
...
```ts
import {tsa, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.17/mod.ts';
...
import {tsa} from 'https://deno.land/x/tsa@v0.0.17/mod.ts';
