...
```bash
deno install --allow-env --allow-net --allow-read --allow-write https://deno.land/x/tsa@v0.0.19/tsa.ts
```
...
```ts
import {tsa, defaultResolve, defaultLoad, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.19/mod.ts';
...
```ts
import {tsa, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.19/mod.ts';
