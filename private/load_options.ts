...
/**	You can pass `LoadOptions`
	...
	import {tsa, defaultLoad, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.24/mod.ts';
	...
	```ts
	import {tsa, defaultResolve, defaultLoad, printDiagnostics} from 'https://deno.land/x/tsa@v0.0.24/mod.ts';
